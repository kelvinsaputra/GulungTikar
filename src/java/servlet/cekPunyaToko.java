 ...
 * @author user
 */
@WebServlet(name = "cekPunyaToko", urlPatterns = {"/cekPunyaToko"})
public class cekPunyaToko extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cekPunyaToko</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cekPunyaToko at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
